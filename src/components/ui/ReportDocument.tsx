...
const ReportDocument: React.FC<ReportDocumentProps> = ({ policies, reflectionData, aiFeedback }) => {
  return (
    <Document>
        ...
        <View style={styles.section}>
          ...
          {aiFeedback && (
            <View style={{ marginBottom: 20 }}>
              <Text style={styles.sectionTitle}>AI Policy Analysis</Text>
              <View style={{ backgroundColor: '#F5F5F5', padding: 10, borderRadius: 5 }}>
                <Text style={styles.paragraph}>{aiFeedback}</Text>
              </View>
            </View>
          )}
